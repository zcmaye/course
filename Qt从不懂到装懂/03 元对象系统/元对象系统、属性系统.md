...
| 智能指针                                                     | 描述 |
| ------------------------------------------------------------ | ---- |
| <font color=rgb(43,145,175) size=4>QPointer</font>           |      |
| <font color=rgb(43,145,175) size=4>QScopedPointer</font>     |      |
| <font color=rgb(43,145,175) size=4>QSharedPointer</font>     |      |
| <font color=rgb(43,145,175) size=4>QWeakPointer</font>       |      |
| <font color=rgb(43,145,175) size=4>QScopedArrayPointer</font> |      |
| <font color=rgb(43,145,175) size=4>QSharedDataPointer</font> |      |
| <font color=rgb(43,145,175) size=4>QExplicitlySharedDataPointer</font> |      |
