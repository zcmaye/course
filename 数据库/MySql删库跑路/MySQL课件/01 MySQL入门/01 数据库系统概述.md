...
+ 第一种方式：在`my.ini`配置文件中的mysqld下加上`skip-grant-tables`![image-20240123165310909](assets/image-20240123165310909.png)。

  然后开启mysql服务，在命令行中输入mysql(`如果端口号不是默认的则需要加上，如：mysql -P 33061`)，如果成功登录，如下图所示：

![image-20240123185206480](assets/image-20240123185206480.png)
